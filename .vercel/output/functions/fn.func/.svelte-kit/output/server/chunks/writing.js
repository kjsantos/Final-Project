const posts = [
  {
    ...
    subtitle: "A collection of different stories, projects, and tutorials I contributed as a freelancer with Open Data Science Conference.",
    content: ""
  },
  {
    ...
    subtitle: "A piece I wrote while writing for Boston University News Service's Data Desk on low income and minority neighborhoods in Boston facing unresolved building problems",
  ...
  },
  {
    ...
    subtitle: "Report on Data Journalism from Boston University's Beat Reporting course",
    content: `<p class = "blog">
...
<br />Amid the current political atmosphere in the U.S., people are becoming disillusioned with both the government and the press. Data may be the only remedy to such unease; when handled with care, it can reshape the relations between the people, the government, and the press using hard, indisputable facts. As high schools and colleges integrate more data science courses, it is likely we will see an extension of those practices to data reporting and the future watchdogs of society.</p>`
  },
  {
    ...
    subtitle: "An interview with New York-based indie band Crumb, conducted for Boston University's The Beat after their show at Tufts University.",
